            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 mb-4">Classic cuts with modern style.</p>
                        ...
                        <div className="space-y-2">
                            ...
                            <div>
                              ...
                              <div className='flex gap-2 mt-2'>
                                ...
                                />
                                <Button variant="outline" className="text-amber-600 hover:text-amber-700 font-medium">
                                  Subscribe
                                </Button>
                              </div>
                            </div>
                ...
                <div className="mt-6 text-center text-gray-400">
                 ...
                 <div className="mt-4 text-center">
                    <button onClick={scrollToTop} className="text-gray-300 hover:text-amber-500 transition-colors">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 10l7-7 7 7M5 17h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
                    </button>
                </div>
            </div>
